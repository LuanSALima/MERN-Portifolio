export const Portuguese  = {
    translation: {
      ...
      AboutProject: {
      	...
      	accordion2_title: 'Pacotes/Bibliotecas Usadas',
      	accordion_subtitle1: 'Front-end',
      	accordion_subtitle2: 'Back-end',
      	...
      	accordion1_text4: 'Texto Original em inglês:',
      	accordion1_link: 'Página Oficial do MongoDB',
      	accordion2_npmjspage: 'Página no npmjs.com',
      	accordion2_documentation: 'Documentação',
      	accordion2_githubpage: 'Página no GitHub',
      	accordion2_officialpage: 'Página Oficial'
      },
      ConfirmEmail: {
